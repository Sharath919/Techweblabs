...
?> 
        ...
        <div class="container">
						...
						<div class="row mt30 justify-content-center">
							<a href="#" target="blank" class="wow fadeIn col-lg-4 col-4"
								data-wow-delay=".2s"><img src="images/about-reviews-icon-1.png"
									alt="Grab Clone Image" class="img-fluid"></a>
							<a href="#" target="blank" class="wow fadeIn col-lg-4 col-4"
          ...
          <div class="col-lg-6 col-md-12"  data-aos="fade-in" data-aos-duration="1500">
            ...
            <img src="images/deliveroo/deliveroo-5.png" alt="Grab Clone Image" class="img-fluid no-shadow">
          </div>
          <!-- banner slides end -->
        </div>
        </div>
			...
			<div class="container">
				<div class="logo-weworkfor owl-carousel">
					<div class="items"><img src="images/logo/vasiredy.png"
							alt="Grab Clone Image" class="img100w"></div>
              ...
              <div class="row small t-ctr mt0">
                  <div class="col-lg-3 col-sm-6">
                      <div class="statistics">
                          <div class="statistics-img"> <img src="images/icons-deal.svg" alt="Grab Clone Image" class="img-fluid"> </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="statistics">
                          <div class="statistics-img"> <img src="images/icons-computers.svg" alt="Grab Clone Image" class="img-fluid"> </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="statistics">
                          <div class="statistics-img"> <img src="images/icons-worker.svg" alt="Grab Clone Image" class="img-fluid"> </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="statistics mb0">
                          <div class="statistics-img"> <img src="images/icons-customer-service.svg" alt="Grab Clone Image" class="img-fluid"> </div>
        ...
        <div class="feature_detail p-0">
          ...
          <div class="left_data feature_box">
            ...
            <div class="data_block" data-aos="fade-right" data-aos-duration="1500">
              <div class="icon">
                <img src="images/deliveroo/deliveroo-1.png" alt="Grab Clone Image" >
              </div>
              <div class="text">
            ...
            <div class="data_block" data-aos="fade-right" data-aos-duration="1500">
              <div class="icon">
                <img src="images/deliveroo/deliveroo-2.png" alt="Grab Clone Image" >
              </div>
              <div class="text">
          ...
          <div class="right_data feature_box">
            ...
            <div class="data_block" data-aos="fade-left" data-aos-duration="1500">
              <div class="icon">
                <img src="images/deliveroo/deliveroo-3.png" alt="Grab Clone Image" >
              </div>
              <div class="text">
                <h4>Food Order</h4>
            ...
            <div class="data_block" data-aos="fade-left" data-aos-duration="1500">
              <div class="icon">
                <img src="images/deliveroo/deliveroo-4.png" alt="Grab Clone Image" >
              </div>
              <div class="text">
                <h4>Taxi Booking</h4>
          ...
          <div class="feature_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
            <img src="images/deliveroo/deliveroo-6.png" alt="Grab Clone Image" >
          </div>
        </div>
      </div>
      <!-- container end -->
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="ui_text">
              <div class="section_titles" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                <h2> Comprehensive User App Features.</h2>
              </div>
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Ride Hailing</h4>
                  <p>Users can request rides from nearby drivers.They can choose from different ride options, including car, taxi, motorbike, and more.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Food Order</h4>
                  <p>Users can order food from local restaurants and have it delivered to their location.They can browse menus, select items, and customize their orders.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Payment and Wallet</h4>
                  <p>Grab offers a digital wallet feature where users can link their bank accounts or credit cards to pay for rides, food deliveries, and other services.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-6.png" alt="Grab Clone Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-7.png" alt="Grab Clone Image" >
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-15.png" alt="Grab Clone Image" >

                <!-- <img class="moving_position_animatin" src="images/deliveroo/deliveroo-5.png" alt="Grab Clone Image" > -->
                <!-- <img class="moving_position_animatin" src="images/modern03.png" alt="Grab Clone Image" > -->
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="row_am modern_ui_section ">
      ...
      <div class="container">
        ...
        <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-8.png" alt="Grab Clone Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-9.png" alt="Grab Clone Image" >
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-10.png" alt="Grab Clone Image" >
                <!-- <img class="moving_position_animatin" src="images/deliveroo/deliveroo-11.png" alt="Grab Clone Image" > -->
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <div class="ui_text">
              ...
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  ...
                  <p>Vendors can receive and manage customer orders placed through the Grab app.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Promotions and Discounts</h4>
                  <p>Vendors can create and manage promotional campaigns and discounts to attract more customers.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Performance Analytics</h4>
                  <p>The app may provide analytics and reports on sales performance, order volumes, and customer feedback.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="ui_text  ml-5 p-0">
              ...
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Accepting and Managing Requests</h4>
                  <p>Drivers can accept ride or delivery requests from nearby users.They can view details of the requested trip or delivery, including pickup and drop-off locations.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Earnings Tracking</h4>
                  <p> Drivers can view their earnings in real-time.They can see a breakdown of earnings by trip or delivery.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Availability and Scheduling</h4>
                  <p>Drivers can set their availability and schedule when they want to accept rides or deliveries.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-12.png" alt="Grab Clone Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-13.png" alt="Grab Clone Image" >
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-14.png" alt="Grab Clone Image" >
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="row_am modern_ui_section ">
      ...
      <div class="container">
        ...
        <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/fashion/fashion-2.png" alt="Grab Clone Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <!-- <img class="moving_position_animatin" src="images/taxigo/cst-2.png" alt="Grab Clone Image" > -->
                <!-- <img class="moving_position_animatin" src="images/taxigo/Taxi Rider.png" alt="Grab Clone Image" > -->
          ...
          <div class="col-lg-6">
              ...
              <ul class="design_block">
                ...
                <h4>Security and Access Control</h4>
                  <p>Ensure the security of the admin panel with user authentication and authorization controls.
Manage admin roles and permissions.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Driver & User Management:</h4>
                  <p>Create, edit, or deactivate user accounts.View user profiles and activity history.Onboard and verify new drivers.
Monitor driver activity, ratings, and compliance with platform policies.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Restaurant and Vendor Management</h4>
                  <p>Onboard and manage restaurant or vendor partnerships.Monitor menu items, prices, and availability.
Resolve issues related to vendor performance.</p>
                </li>
...
<!-- testinomial End -->
    ...
    <section class="service pad-tb bg-gradient5">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="image-block wow fadeIn"> <img src="images/deliveroo/deliveroo-5.png" width="100%" hight="700px" alt="Grab Clone Image" class="img-fluid no-shadow"> </div>
                </div>
                <div class="col-lg-7 block-1">
                    <div class="common-heading text-l pl25"> <span>Overview</span>
                        <h2>Techweblabs Support: Your Key to a Successful Grab Clone App</h2>
                        <p>With a wealth of expertise accumulated over 6 years, Techweblabs emerges as a distinguished leader in Grab-App Clone app support and development. Our comprehensive support services for Grab-App Clone Apps are thoughtfully designed to elevate brand recognition and propel significant sales growth for entrepreneurs in the food delivery and ride-hailing industry, mirroring the success achieved by industry giants in these sectors.</p>
                        <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>  
                    </div>
                </div>
    ...
    <div class="techonology-used-">
        <div class="container">
            <ul class="h-scroll tech-icons">
                <li><a href="#"><img src="images/icons/mobile/android.png" alt="Grab Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/ios.png" alt="Grab Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/flutter.png" alt="Grab Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/react.png" alt="Grab Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/kotlin.png" alt="Grab Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/swift.png" alt="Grab Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/maps.png" alt="Grab Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/firebase.png" alt="Grab Clone Image"></a></li>
        ...
        <div class="row upset link-hover">
            <div class="col-lg-6 col-sm-6 mt30  wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item2.png" alt="Grab Clone Image" class="img-fluid"></div>
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item1.png" alt="Grab Clone Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item3.png" alt="Grab Clone Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item4.png" alt="Grab Clone Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
    ...
    <div class="container">
        ...
        <div class="row upset justify-content-center mt60">
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-1.jpg" alt="Grab Clone Image" class="img-fluid"> </div>
            </div>
        ...
        <div class="row upset justify-content-center mt60">
            ...
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-2.jpg" alt="Grab Clone Image" class="img-fluid"> </div>
            </div>
        </div>
        <div class="row upset justify-content-center mt60">
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-3.jpg" alt="Grab Clone Image" class="img-fluid"> </div>
            </div>
            <div class="col-lg-7 v-center order2">
        ...
        <div class="row upset justify-content-center mt60">
            ...
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-4.jpg" alt="Grab Clone Image" class="img-fluid"> </div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-teama.svg" alt="Grab Clone Image" class="img-fluid"></div>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-link.svg" alt="Grab Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-tech.svg" alt="Grab Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-hi.svg" alt="Grab Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-badge.svg" alt="Grab Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-tin.svg" alt="Grab Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
...
<div class="logowide mb20"><img src="images/client/customer-logo-5.png" alt="Grab Clone Image" class="img-fluid"></div>
...
<div class="desktopblock shadow1"><img src="images/portfolio/portfolio-wide-1.jpg" alt="Grab Clone Image" class="img-fluid"> </div>
<div class="mobileblock shadow1"><img src="images/portfolio/portfolio-wide-1a.jpg" alt="Grab Clone Image" class="img-fluid"> </div>
</div>
</div>
</div>
</div>
                                ...
                                <div id="mc_embed_signup_scroll">
                                    ...
                                    <div class="optionalParent">
                                        <div class="clear foot"> <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button" value="Subscribe">
                                            <p style="margin: 0px auto;"><a href="http://eepurl.com/izSV7w" title="Mailchimp - email marketing made easy and fun"><span style="display: inline-block; background-color: transparent; border-radius: 4px;"><img class="refferal_badge" src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/intuit-mc-rewards-text-dark.svg" alt="Grab Clone Image" style="width: 220px; height: 40px; display: flex; padding: 2px 0px; justify-content: center; align-items: center;"></span></a></p>
                                        </div>
                                    </div>
                                </div>
                            </form>
