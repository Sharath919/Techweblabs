...
<head>
    ...
    <!-- SEO Optimized Title -->
    <title>BigBasket Clone App Development | Grocery Delivery Application Development | TechWebLabs</title>
    
    <!-- SEO Optimized Meta Description -->
    <meta name="description" content="Build a BigBasket clone app with TechWebLabs. Expert grocery delivery application development services. Custom BigBasket clone solutions for grocery businesses. Get your grocery delivery app developed today.">
    
    <!-- SEO Keywords -->
    <meta name="keywords" content="bigbasket clone app development, bigbasket clone application development, grocery delivery app development, online grocery app, grocery shopping app development, bigbasket clone app, grocery delivery application development">
    
    <meta name="author" content="TechWebLabs">
    <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
    
    <!-- Canonical URL -->
    <link rel="canonical" href="https://techweblabs.com/bigbasket-clone">
    
    <!-- Open Graph Meta Tags -->
    <meta property="og:title" content="BigBasket Clone App Development | Grocery Delivery Application Development | TechWebLabs">
    <meta property="og:description" content="Build a BigBasket clone app with TechWebLabs. Expert grocery delivery application development services. Custom BigBasket clone solutions for grocery businesses.">
    <meta property="og:image" content="https://techweblabs.com/images/bigbasket/bigbasket-home.png">
    <meta property="og:url" content="https://techweblabs.com/bigbasket-clone">
    ...
    <meta name="twitter:title" content="BigBasket Clone App Development | Grocery Delivery Application Development">
    <meta name="twitter:description" content="Build a BigBasket clone app with TechWebLabs. Expert grocery delivery application development services.">
    <meta name="twitter:image" content="https://techweblabs.com/images/bigbasket/bigbasket-home.png">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Service",
      "serviceType": "BigBasket Clone App Development",
      "name": "BigBasket Clone App Development Services",
      "description": "Build a BigBasket clone app with TechWebLabs. Expert grocery delivery application development services. Custom BigBasket clone solutions for grocery businesses.",
      "provider": {
        "@type": "Organization",
        "name": "TechWebLabs",
      ...
      "url": "https://techweblabs.com/bigbasket-clone",
      "offers": {
        "@type": "Offer",
        "priceCurrency": "INR",
    ...
    <script type="application/ld+json">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 2,
          "name": "BigBasket Clone App Development",
          "item": "https://techweblabs.com/bigbasket-clone"
        }
      ]
    }
    </script>
    ...
    <script type="application/ld+json">
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is BigBasket clone app development?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "BigBasket clone app development involves creating a grocery delivery application similar to BigBasket with features like product catalog, shopping cart, order management, real-time tracking, payment processing, and delivery scheduling. It includes customer app, store app, and delivery partner app."
          }
        },
        {
          "@type": "Question",
          "name": "How much does it cost to develop a BigBasket clone app?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The cost of developing a BigBasket clone app depends on features and complexity. Basic apps with core features typically cost $25,000-$50,000. Advanced apps with AI recommendations, subscription management, multiple store support, and comprehensive admin panels can cost $60,000-$150,000 or more. Contact TechWebLabs for a customized quote."
          }
        },
        {
          "@type": "Question",
          "name": "What features should a BigBasket clone app have?",
          "acceptedAnswer": {
            "@type": "Answer",
        ...
        {
          "@type": "Question",
          "name": "How long does it take to develop a BigBasket clone app?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "A basic BigBasket clone app with core features typically takes 4-6 months. A medium-complexity app with advanced features takes 6-9 months. Complex apps with AI, multiple integrations, and comprehensive admin panels can take 9-12 months or more. TechWebLabs provides detailed timelines based on your project scope."
          }
        },
        {
          "@type": "Question",
          "name": "Can you develop a BigBasket clone app like the original BigBasket?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, TechWebLabs can develop BigBasket clone apps with similar features to the original BigBasket, including grocery ordering, delivery scheduling, subscription management, and real-time tracking. We create custom solutions tailored to your business model, target market, and specific requirements."
          }
        },
        {
          "@type": "Question",
          "name": "Which technology stack is best for BigBasket clone app development?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "For native apps: iOS (Swift) and Android (Kotlin). For cross-platform: React Native or Flutter. Backend: Node.js, Python, or PHP. Database: PostgreSQL or MongoDB. Real-time tracking: WebSocket or Firebase. Payment: Stripe, PayPal, Razorpay. Cloud: AWS, Google Cloud, or Azure. TechWebLabs uses modern, scalable tech stacks."
          }
        }
      ]
    }
        ...
        <div class="container">
          ...
          <div class="col-lg-6 col-md-12"  data-aos="fade-right" data-aos-duration="1500">
            ...
            <div class="banner_text">
              ...
              <h1>BigBasket Clone App Development | Grocery Delivery Application Development</h1>
              <!-- p -->
              <p>Build a BigBasket clone app with TechWebLabs. We provide expert grocery delivery application development services. Our custom BigBasket clone solutions for grocery businesses include features like real-time inventory management, slot-based delivery, multiple payment options, order tracking, and store management dashboard. Get your grocery delivery app developed today.
              </p>
						...
						<div class="row mt30 justify-content-center">
							<a href="#" target="blank" class="wow fadeIn col-lg-4 col-4"
								data-wow-delay=".2s"><img src="images/about-reviews-icon-1.png"
									alt="Bigbasket Clone Image" class="img-fluid"></a>
							<a href="#" target="blank" class="wow fadeIn col-lg-4 col-4"
          ...
          <div class="col-lg-6 col-md-12"  data-aos="fade-in" data-aos-duration="1500">
            ...
            <img src="images/grocery/grocery-2.png" alt="Bigbasket Clone Image" class="img-fluid no-shadow">
          </div>
          <!-- banner slides end -->
        </div>
        </div>
			...
			<div class="container">
				<div class="logo-weworkfor owl-carousel">
					<div class="items"><img src="images/logo/vasiredy.png"
							alt="Bigbasket Clone Image" class="img100w"></div>
        ...
        <div class="feature_detail p-0">
          ...
          <div class="left_data feature_box">
            ...
            <div class="data_block" data-aos="fade-right" data-aos-duration="1500">
              <div class="icon">
                <img src="images/secure_data.png" alt="Bigbasket Clone Image" >
              </div>
              <div class="text">
                <h4>Lower delivery costs by optimizing routes.</h4>
            ...
            <div class="data_block" data-aos="fade-right" data-aos-duration="1500">
              <div class="icon">
                <img src="images/functional.png" alt="Bigbasket Clone Image" >
              </div>
              <div class="text">
                <h4>Effortless Integration</h4>
                <p> Harness robust and limitless integrations to enhance the capabilities of your Instacart/ Bigbasket Clone.</p>
              </div>
            </div>
          </div>
          ...
          <div class="right_data feature_box">
            ...
            <div class="data_block" data-aos="fade-left" data-aos-duration="1500">
              <div class="icon">
                <img src="images/live-chat.png" alt="Bigbasket Clone Image" >
              </div>
              <div class="text">
                <h4>Comprehensive Tracking </h4>
                <p>Monitor deliveries, analyze customer behavior, and enhance the overall experience with a cutting-edge analytics system.</p>
              </div>
            </div>
            ...
            <div class="data_block" data-aos="fade-left" data-aos-duration="1500">
              <div class="icon">
                <img src="images/support.png" alt="Bigbasket Clone Image" >
              </div>
              <div class="text">
          ...
          <div class="feature_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
            <img src="images/grocery/grocery-3.png" alt="Bigbasket Clone Image" >
          </div>
        </div>
      </div>
      <!-- container end -->
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="ui_text">
              <div class="section_titles" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                <h2> Where Contemporary User Interface Meets Stunning Design.</h2>
              </div>
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Enhanced Search</h4>
                  <p>Provide your customers with a convenient means to locate and select groceries using an advanced search feature.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                ...
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Safe Payment Choices</h4>
                  <p>Provide a variety of secure payment options for the best grocery delivery experience.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/grocery/grocery-4.png" alt="Bigbasket Clone Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
              
                <img class="moving_position_animatin" src="images/grocery/grse-2.png" alt="Bigbasket Clone Image" >
                <img class="moving_position_animatin" src="images/grocery/grse-1.png" alt="Bigbasket Clone Image" >
                <!-- <img class="moving_position_animatin" src="images/modern03.png" alt="Bigbasket Clone Image" > -->
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="row_am modern_ui_section ">
      ...
      <div class="container">
        ...
        <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/grocery/ride-2.png" alt="Bigbasket Clone Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
               
                <!-- <img class="moving_position_animatin" src="images/grocery/ride-2.png" alt="Bigbasket Clone Image" > -->
                <img class="moving_position_animatin" src="images/grocery/ride-1.png" alt="Bigbasket Clone Image" >
                <img class="moving_position_animatin" src="images/grocery/grae-3.png" alt="Bigbasket Clone Image" >
              </div>
            </div>
          </div>
          <div class="col-lg-6">
              ...
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Instant Order Alerts</h4>
                  <p>Deliver immediate order notifications to the driver's app, including comprehensive grocery order details.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Daily Earning Reports</h4>
                  <p>Agents can easily track their daily earning based on the number of deliveries & working hours.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Optimized Routes</h4>
                  <p> Provide drivers with the shortest and quickest delivery routes for on-time grocery order deliveries.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="ui_text">
              <div class="section_titles" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
                <h2> Key Features of the BigBasket Clone Vendor App</h2>
              </div>
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Order Management</h4>
                  <p> Vendors can receive and manage incoming orders from BigBasket customers through the app.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Inventory Management</h4>
                  <p>Vendors can monitor and update their inventory levels, ensuring that they have sufficient stock to fulfill customer orders.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Performance Analytics</h4>
                  <p> The app may provide vendors with insights into their sales performance, including order volume, revenue, and customer feedback.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
    ...
    <section class="row_am modern_ui_section ">
      ...
      <div class="container">
        ...
        <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/pet/admin-panel.png" alt="Bigbasket Clone Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
          ...
          <div class="col-lg-6">
              ...
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Payments & Commissions</h4>
                  <p>Admin can set commission percentage, delivery charges, surge pricing, etc. all from one place.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Monitor Deliveries</h4>
                  <p>Assign delivery tasks to agents & track each and every moment of your fleet in real-time.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Business Insights</h4>
                  <p>Enable vendors to monitor their earnings and access valuable insights into their business performance.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
...
<!-- testinomial End -->
    ...
    <section class="service pad-tb bg-gradient5">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="image-block wow fadeIn"> <img src="images/grocery/grocery-2.png" width="100%" hight="700px" alt="Bigbasket Clone Image" class="img-fluid no-shadow"> </div>
                </div>
                <div class="col-lg-7 block-1">
                    <div class="common-heading text-l pl25"> <span>Overview</span>
                        <h2>Creating a BigBasket clone app tailored to your grocery business</h2>
                        <p> At Techweblabs, we specialize in developing custom mobile applications designed to meet the precise requirements of your grocery-related venture. Our dedicated team of professionals works closely with you to understand your objectives, target customer base, and the distinctive hurdles you face. We leverage the latest technologies and industry expertise to design BigBasket clone apps that not only address your business challenges but also provide an intuitive and enjoyable user experience.</p>
    ...
    <div class="techonology-used-">
        <div class="container">
            <ul class="h-scroll tech-icons">
                <li><a href="#"><img src="images/icons/mobile/android.png" alt="Bigbasket Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/ios.png" alt="Bigbasket Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/flutter.png" alt="Bigbasket Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/react.png" alt="Bigbasket Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/kotlin.png" alt="Bigbasket Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/swift.png" alt="Bigbasket Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/maps.png" alt="Bigbasket Clone Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/firebase.png" alt="Bigbasket Clone Image"></a></li>
        ...
        <div class="row upset link-hover">
            <div class="col-lg-6 col-sm-6 mt30  wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item2.png" alt="Bigbasket Clone Image" class="img-fluid"></div>
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item1.png" alt="Bigbasket Clone Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item3.png" alt="Bigbasket Clone Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item4.png" alt="Bigbasket Clone Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
    ...
    <div class="container">
        ...
        <div class="row upset justify-content-center mt60">
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-1.jpg" alt="Bigbasket Clone Image" class="img-fluid"> </div>
            </div>
        ...
        <div class="row upset justify-content-center mt60">
            ...
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-2.jpg" alt="Bigbasket Clone Image" class="img-fluid"> </div>
            </div>
        </div>
        <div class="row upset justify-content-center mt60">
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-3.jpg" alt="Bigbasket Clone Image" class="img-fluid"> </div>
            </div>
            <div class="col-lg-7 v-center order2">
        ...
        <div class="row upset justify-content-center mt60">
            ...
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-4.jpg" alt="Bigbasket Clone Image" class="img-fluid"> </div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-teama.svg" alt="Bigbasket Clone Image" class="img-fluid"></div>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-link.svg" alt="Bigbasket Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-tech.svg" alt="Bigbasket Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-hi.svg" alt="Bigbasket Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-badge.svg" alt="Bigbasket Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-tin.svg" alt="Bigbasket Clone Image" class="img-fluid"></div>
                    <div class="s-block-content">
...
<div class="logowide mb20"><img src="images/client/customer-logo-5.png" alt="Bigbasket Clone Image" class="img-fluid"></div>
...
<div class="desktopblock shadow1"><img src="images/portfolio/portfolio-wide-1.jpg" alt="Bigbasket Clone Image" class="img-fluid"> </div>
<div class="mobileblock shadow1"><img src="images/portfolio/portfolio-wide-1a.jpg" alt="Bigbasket Clone Image" class="img-fluid"> </div>
</div>
</div>
</div>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="common-heading">
                    <h2 class="mb30">Frequently Asked Questions About BigBasket Clone App Development</h2>
                    <p class="mb60">Get answers to common questions about building grocery delivery applications.</p>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq1">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                What is BigBasket clone app development?
                            </button>
                        </h2>
                        <div id="collapse1" class="accordion-collapse collapse show" aria-labelledby="faq1" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                <p>BigBasket clone app development involves creating a grocery delivery application similar to BigBasket with features like product catalog, shopping cart, order management, real-time tracking, payment processing, and delivery scheduling. It includes customer app, store app, and delivery partner app.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq3">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                What features should a BigBasket clone app have?
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq4">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
                                How long does it take to develop a BigBasket clone app?
                            </button>
                        </h2>
                        <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="faq4" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                <p>A basic BigBasket clone app with core features typically takes 4-6 months. A medium-complexity app with advanced features takes 6-9 months. Complex apps with AI, multiple integrations, and comprehensive admin panels can take 9-12 months or more. TechWebLabs provides detailed timelines based on your project scope.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq5">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse5" aria-expanded="false" aria-controls="collapse5">
                                Can you develop a BigBasket clone app like the original BigBasket?
                            </button>
                        </h2>
                        <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="faq5" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                <p>Yes, TechWebLabs can develop BigBasket clone apps with similar features to the original BigBasket, including grocery ordering, delivery scheduling, subscription management, and real-time tracking. We create custom solutions tailored to your business model, target market, and specific requirements.</p>
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq6">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                                Which technology stack is best for BigBasket clone app development?
                            </button>
                        </h2>
                                ...
                                <div id="mc_embed_signup_scroll">
                                    ...
                                    <div class="optionalParent">
                                        <div class="clear foot"> <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button" value="Subscribe">
                                            <p style="margin: 0px auto;"><a href="http://eepurl.com/izSV7w" title="Mailchimp - email marketing made easy and fun"><span style="display: inline-block; background-color: transparent; border-radius: 4px;"><img class="refferal_badge" src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/intuit-mc-rewards-text-dark.svg" alt="Bigbasket Clone Image" style="width: 220px; height: 40px; display: flex; padding: 2px 0px; justify-content: center; align-items: center;"></span></a></p>
                                        </div>
                                    </div>
                                </div>
                            </form>
