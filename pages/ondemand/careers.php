...
<head>
    <title>Careers | Top Mobile App Development by Techweblabs</title>
    <meta name="description" content="Careers solutions by Techweblabs, leading mobile app development company. Get innovative and efficient careers services tailored to your needs.">
    <meta name="keywords" content="Careers, Mobile App Development, Techweblabs, best app development, custom app solutions, professional mobile app development">
    <meta name="author" content="Techweblabs">
    
    <!-- Open Graph Meta Tags for Social Media -->
    <meta property="og:title" content="Careers | Techweblabs">
    <meta property="og:description" content="Techweblabs offers top-notch careers solutions. Experience the best in mobile app development.">
    <meta property="og:image" content="https://www.techweblabs.com/images/mobile-app-development.jpg">
    <meta property="og:url" content="https://www.techweblabs.com/careers">
    <meta property="og:type" content="website">

    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="Careers | Techweblabs">
    <meta name="twitter:description" content="Techweblabs delivers outstanding careers services. Discover innovative mobile app development solutions.">
  ...
  <meta charset="utf-8">
  <title>Techweblabs &amp;Careers | App Development Company in Hyderabad</title>
  <meta name="description" content="Careers | App Development Company in Hyderabad">
  <meta name="keywords" content="Techweblabs,Careers">
  <meta name="author" content="Techweblabs">
...
<section class="breadcrumb-area banner-1">
  ...
  <section class="service-section-app pad-tb dark-bg2" style="margin-top: 80px;">
			<div class="sctxt">Techweblabs</div>
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-6">
						<div class="common-heading ptag">
							<span>Careers</span>
							<h2>Let's Join Our Team</h2>
							<p class="mb30">Explore Exciting Career Opportunities at
              TechWebLabs.</p>
						</div>
					</div>
				</div>
						...
						<div class="service-card-app hoshd">
							...
							<div class="tec-icon mt30">
								<ul class="servc-icon-sldr">
									<li><a href="#"><div class="img-iconbb"><img
													src="images/icons-android.svg" alt="Careers Image"></div> </a></li>
									<li><a href="#"><div class="img-iconbb"><img
													src="images/icons-apple.svg" alt="Careers Image"></div> </a></li>
									<li><a href="#"><div class="img-iconbb"><img
													src="images/icons-tablet.svg" alt="Careers Image"></div> </a></li>
								</ul>
							</div>
							<!-- <h4>Backend Developer</h4>S -->
              <br>
              <p>3+ Years</p>
              <p>Flutter</p><br>
              <a href="https://api.whatsapp.com/send?phone=917670837961&text=Hi%20Techweblabs%2C%20I%20am%20interested%20" class="btn-main bg-btn3 lnk mt20" data-bs-toggle="modal" data-bs-target="#modalform">Apply Now<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
						...
						<div class="service-card-app hoshd">
							...
							<div class="tec-icon mt30">
								<ul class="servc-icon-sldr">
									...
									<li><a href="#"><div class="img-iconbb"><img src="images/icons-php.svg"
													alt="Careers Image"></div></a></li>
									<li><a href="#"><div class="img-iconbb"><img
													src="images/nodejs-icon-logo-svgrepo-com.svg" alt="Careers Image"></div></a></li>
									<li><a href="#"><div class="img-iconbb"><img
													src="images/icons-wordpress.svg" alt="Careers Image"></div></a></li>
									<li><a href="#"><div class="img-iconbb"><img
              ...
              <a href="https://api.whatsapp.com/send?phone=917670837961&text=Hi%20Techweblabs%2C%20I%20am%20interested%20" class="btn-main bg-btn3 lnk mt20" data-bs-toggle="modal" data-bs-target="#modalform">Apply Now<i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                ...
                <li> <a href="#">PHP</a> </li>
							...
							<div class="tec-icon mt30">
								<ul class="servc-icon-sldr">
									<li><a href="#"><div class="img-iconbb"><img
													src="images/figma-svgrepo-com.svg" alt="Careers Image"></div></a></li>
                          <li><a href="#"><div class="img-iconbb"><img
													src="images/nodejs-icon-logo-svgrepo-com.svg" alt="Careers Image"></div></a></li>
									<li><a href="#"><div class="img-iconbb"><img
													src="images/icons-wordpress.svg" alt="Careers Image"></div></a></li>
              ...
              <p>Fresher</p>
							<p >2023 and 2024 graduates only</p><br>
  ...
  <div class="techonology-used-">
    <div class="container">
      <ul class="h-scroll tech-icons">
        <li><a href="#"><img src="images/icons/mobile/android.png" alt="Careers Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/ios.png" alt="Careers Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/flutter.png" alt="Careers Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/react.png" alt="Careers Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/kotlin.png" alt="Careers Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/swift.png" alt="Careers Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/maps.png" alt="Careers Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/firebase.png" alt="Careers Image"></a></li>
			...
			<div class="container">
				<div class="logo-weworkfor owl-carousel">
					<div class="items"><img src="images/logo/vasiredy.png"
							alt="Careers Image" class="img100w"></div>
						...
						<div class="row mt30 justify-content-center">
							<a href="#" target="blank" class="wow fadeIn col-lg-4 col-4"
								data-wow-delay=".2s"><img src="images/about-reviews-icon-1.png"
									alt="Careers Image" class="img-fluid"></a>
							<a href="#" target="blank" class="wow fadeIn col-lg-4 col-4"
      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="text-l service-desc- pr25">
            ...
            <a href="https://api.whatsapp.com/send?phone=917670837961&text=Hi%20Techweblabs%2C%20I%20am%20interested%20in%20your%20taxi%20booking%20app%20development%20services!" class="btn-outline lnk mt30">Request A Quote <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          </div>
        </div>
        <div class="col-lg-5">
      ...
      <div class="row upset link-hover">
        <div class="col-lg-6 col-sm-6 mt30  wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
          <div class="s-block wide-sblock">
            <div class="s-card-icon-large"><img src="images/service-mob-service-item2.png" alt="Careers Image" class="img-fluid"></div>
        ...
        <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
          <div class="s-block wide-sblock">
            <div class="s-card-icon-large"><img src="images/service-mob-service-item1.png" alt="Careers Image" class="img-fluid"></div>
            <div class="s-block-content-large">
        ...
        <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
          <div class="s-block wide-sblock">
            <div class="s-card-icon-large"><img src="images/service-mob-service-item3.png" alt="Careers Image" class="img-fluid"></div>
            <div class="s-block-content-large">
        ...
        <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
          <div class="s-block wide-sblock">
            <div class="s-card-icon-large"><img src="images/service-mob-service-item4.png" alt="Careers Image" class="img-fluid"></div>
            <div class="s-block-content-large">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-teama.svg" alt="Careers Image" class="img-fluid"></div>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-link.svg" alt="Careers Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-tech.svg" alt="Careers Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-hi.svg" alt="Careers Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-badge.svg" alt="Careers Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-tin.svg" alt="Careers Image" class="img-fluid"></div>
                    <div class="s-block-content">
...
<div class="logowide mb20"><img src="images/client/customer-logo-5.png" alt="Careers Image" class="img-fluid"></div>
...
<div class="desktopblock shadow1"><img src="images/portfolio/portfolio-wide-1.jpg" alt="Careers Image" class="img-fluid"> </div>
<div class="mobileblock shadow1"><img src="images/portfolio/portfolio-wide-1a.jpg" alt="Careers Image" class="img-fluid"> </div>
</div>
</div>
</div>
</div>
                ...
                <div id="mc_embed_signup_scroll">
                  ...
                  <div class="optionalParent">
                    <div class="clear foot"> <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button" value="Subscribe">
                      <p style="margin: 0px auto;"><a href="http://eepurl.com/izSV7w" title="Mailchimp - email marketing made easy and fun"><span style="display: inline-block; background-color: transparent; border-radius: 4px;"><img class="refferal_badge" src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/intuit-mc-rewards-text-dark.svg" alt="Careers Image" style="width: 220px; height: 40px; display: flex; padding: 2px 0px; justify-content: center; align-items: center;"></span></a></p>
                    </div>
                  </div>
                </div>
              </form>
