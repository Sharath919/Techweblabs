...
?>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12" data-aos="fade-right" data-aos-duration="1500">
          ...
          <div class="banner_text">
            ...
            <h1>Unlock success In food Delivery With Techweblabs</h1>
            <!-- p -->
            ...
            <a href="https://api.whatsapp.com/send?phone=917670837961&text=Hi%20Techweblabs%2C%20I%20am%20interested%20in%20your%20food%20delivery%20app%20development%20services!" class="btn-outline lnk mt30">Request A Quote <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          </div>
          ...
          <div class="row mt30 justify-content-center">
            <a href="#" target="blank" class="wow fadeIn col-lg-4 col-4" data-wow-delay=".2s"><img src="images/about-reviews-icon-1.png" alt="Food Delivery App Development Image" class="img-fluid"></a>
            <a href="#" target="blank" class="wow fadeIn col-lg-4 col-4" data-wow-delay=".4s"><img src="images/about-reviews-icon-2.png" alt="Food Delivery App Development Image" class="img-fluid"></a>
            <a href="#" target="blank" class="wow fadeIn col-lg-4 col-4" data-wow-delay=".6s"><img src="images/about-reviews-icon-3.png" alt="Food Delivery App Development Image" class="img-fluid"></a>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-12" data-aos="fade-in" data-aos-duration="1500">
          ...
          <img src="images/deliveroo/deliveroo-5.png" alt="Food Delivery App Development Image" class="img-fluid no-shadow">
        </div>
        <!-- banner slides end -->
      </div>
    </div>
  ...
  <div class="weworkfor pt20 pb20 dark-bg2">
    <div class="container">
      <div class="logo-weworkfor owl-carousel">
        <div class="items"><img src="images/logo/vasiredy.png" alt="Food Delivery App Development Image" class="img100w"></div>
        <div class="items"><img src="images/logo/chicago.png" alt="Food Delivery App Development Image" class="img100w"></div>
        <div class="items"><img src="images/logo/horeka.png" alt="Food Delivery App Development Image" class="img100w"></div>
        <div class="items"><img src="images/logo/1989.png" alt="Food Delivery App Development Image" class="img100w"></div>
        <div class="items"><img src="images/logo/loanwolf.png" alt="Food Delivery App Development Image" class="img100w"></div>
        <div class="items"><img src="images/logo/metfolio.png" alt="Food Delivery App Development Image" class="img100w"></div>
        <div class="items"><img src="images/logo/pcw.png" alt="Food Delivery App Development Image" class="img100w"></div>
        <div class="items"><img src="images/logo/workmate.png" alt="Food Delivery App Development Image" class="img100w"></div>
      </div>
    </div>
  </div>
      ...
      <div class="feature_detail p-0">
        ...
        <div class="left_data feature_box">
          ...
          <div class="data_block" data-aos="fade-right" data-aos-duration="1500">
            <div class="icon">
              <img src="images/deliveroo/deliveroo-1.png" alt="Food Delivery App Development Image">
            </div>
            <div class="text">
              <h4>Notifications and Alerts </h4>
              <p> Push notifications for order confirmation, updates, and promotions.
                Order status updates through SMS or email.
              </p>
            </div>
          </div>
          ...
          <div class="data_block" data-aos="fade-right" data-aos-duration="1500">
            <div class="icon">
              <img src="images/deliveroo/deliveroo-2.png" alt="Food Delivery App Development Image">
            </div>
            <div class="text">
              <h4>Secure Payment Options</h4>
              <p> Multiple payment methods, including credit/debit cards, digital wallets, and cash on delivery.
        ...
        <div class="right_data feature_box">
          ...
          <div class="data_block" data-aos="fade-left" data-aos-duration="1500">
            <div class="icon">
              <img src="images/deliveroo/deliveroo-3.png" alt="Food Delivery App Development Image">
            </div>
            <div class="text">
              <h4>Driver Safety</h4>
          ...
          <div class="data_block" data-aos="fade-left" data-aos-duration="1500">
            <div class="icon">
              <img src="images/deliveroo/deliveroo-4.png" alt="Food Delivery App Development Image">
            </div>
            <div class="text">
              <h4>Real-Time Tracking</h4>
              <p>Track the status of orders in real-time, from preparation to delivery.
                Live order tracking on a map with estimated delivery times.</p>
            </div>
          </div>
        ...
        <div class="feature_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
          <img src="images/deliveroo/deliveroo-6.png" alt="Food Delivery App Development Image">
        </div>
      </div>
    </div>
    <!-- container end -->
      ...
      <div class="row">
          ...
          <div class="ui_text">
            ...
            <ul class="design_block">
              <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Secure Payment Options</h4>
                <p>Multiple payment methods such as credit/debit cards, digital wallets, and cash on delivery.
                  Secure and encrypted payment processing.</p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Restaurant Listings</h4>
                <p>Search and browse nearby restaurants based on location, cuisine, or ratings.
                  Detailed restaurant profiles with menus, prices, and images.</p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Delivery Driver Information</h4>
                <p>Receive details about the assigned delivery driver, including name and contact information.</p>
              </li>
            </ul>
            <a href="https://api.whatsapp.com/send?phone=917670837961&text=Hi%20Techweblabs%2C%20I%20am%20interested%20in%20your%20food%20delivery%20app%20development%20services!" class="btn-outline lnk mt30">Request A Quote <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
        ...
        <div class="col-lg-6">
          ...
          <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
            <div class="left_img">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-6.png" alt="Food Delivery App Development Image">
            </div>
            <!-- UI Image -->
            <div class="right_img">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-7.png" alt="Food Delivery App Development Image">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-15.png" alt="Food Delivery App Development Image">

              <!-- <img class="moving_position_animatin" src="images/deliveroo/deliveroo-5.png" alt="Food Delivery App Development Image" > -->
              <!-- <img class="moving_position_animatin" src="images/modern03.png" alt="Food Delivery App Development Image" > -->
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
            <div class="left_img">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-8.png" alt="Food Delivery App Development Image">
            </div>
            <!-- UI Image -->
            <div class="right_img">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-9.png" alt="Food Delivery App Development Image">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-10.png" alt="Food Delivery App Development Image">
              <!-- <img class="moving_position_animatin" src="images/deliveroo/deliveroo-11.png" alt="Food Delivery App Development Image" > -->
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          ...
          <div class="ui_text">
            ...
            <ul class="design_block">
              <li data-aos="fade-up" data-aos-duration="1500">
                ...
                <p>Add, edit, and remove menu items.Set prices, descriptions, and images for each dish.Categorize menu items by type (appetizers, entrees, desserts, etc.). Enable or disable items based on availability.</p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Restaurant Registration</h4>
                <p>A simple and straight forward registration process for restaurants to join the platform.</p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Billing and Payment Processing</h4>
                <p>Generate invoices for completed orders.Support for multiple payment methods and integration with payment gateways.</p>
              </li>
            </ul>
            <a href="https://api.whatsapp.com/send?phone=917670837961&text=Hi%20Techweblabs%2C%20I%20am%20interested%20in%20your%20food%20delivery%20app%20development%20services!" class="btn-outline lnk mt30">Request A Quote <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="ui_text  ml-5 p-0">
            <div class="section_titles" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
              <h2>Empowers driver apps for efficiency and convenience</h2>
            </div>
            <ul class="design_block">
              <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Payment Tracking</h4>
                <p>Track earnings and view payment history.
                  Receive notifications for payment transfers.</p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Order Management</h4>
                <p> Receive and manage incoming delivery orders.
                  Accept or decline orders based on availability or distance.</p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
        ...
        <div class="col-lg-6">
          ...
          <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
            <div class="left_img">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-12.png" alt="Food Delivery App Development Image">
            </div>
            <!-- UI Image -->
            <div class="right_img">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-13.png" alt="Food Delivery App Development Image">
              <img class="moving_position_animatin" src="images/deliveroo/deliveroo-14.png" alt="Food Delivery App Development Image">
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
            <div class="left_img">
              <img class="moving_position_animatin" src="images/adminpanel.png" alt="Food Delivery App Development Image">
            </div>
            <!-- UI Image -->
            <div class="right_img">
              <!-- <img class="moving_position_animatin" src="images/foodgo/cst-2.png" alt="Food Delivery App Development Image" > -->
              <!-- <img class="moving_position_animatin" src="images/taxigo/Taxi Rider.png" alt="Food Delivery App Development Image" > -->
          ...
          <div class="ui_text  ml-5 p-0">
            ...
            <ul class="design_block">
              <li data-aos="fade-up" data-aos-duration="1500">
                ...
                <p>Manage user accounts, including customers, drivers, and restaurant partners.
                  User registration, verification, and account suspension or termination.</p>
              </li>
              <li data-aos="fade-up" data-aos-duration="1500">
              ...
              <li data-aos="fade-up" data-aos-duration="1500">
                ...
                <p>Generate reports on sales, order volumes, customer behavior, and more.
                  Analyze trends and make data-driven decisions.</p>
              </li>
  ...
  <section class="testinomial-section-app bg-none pad-tb">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-7 ">
          <div class="pl50">
            <div class="shape shape-a1"><img src="images/shape-shape-3.svg" alt="Food Delivery App Development Image"></div>
            <div class="testimonial-card-a tcd owl-carousel">
              <div class="testimonial-card">
                ...
                <div class="client-thumbs mt30">
                  <div class="media v-center upset">
                    <div class="user-image bdr-radius"><img src="images\iig-client.jpeg" alt="Food Delivery App Development Image" class="img-fluid rounded-circle"></div>
              ...
              <div class="testimonial-card">
                ...
                <div class="client-thumbs mt30">
                  <div class="media v-center upset">
                    <div class="user-image bdr-radius"><img src="images\taxigo-client.jpg" alt="Food Delivery App Development Image" class="img-fluid rounded-circle"></div>
                    <div class="media-body user-info v-center">
                      <h5>Sujith Reddy</h5>
  ...
  <section class="service pad-tb bg-gradient5">
    <div class="container">
      <div class="row">
        <div class="col-lg-5">
          <div class="image-block wow fadeIn"> <img src="images/deliveroo/deliveroo-5.png" width="100%" hight="700px" alt="Food Delivery App Development Image" class="img-fluid no-shadow"> </div>
        </div>
        <div class="col-lg-7 block-1">
          <div class="common-heading text-l pl25"> <span>Overview</span>
            <h2>Techweblabs Support: Your Key to a Successful Food Delivery App</h2>
            <p> At Techweblabs, we excel in crafting tailor-made mobile applications that cater to the specific needs of your food-related enterprise. Our dedicated team of experts collaborates closely with you to gain insights into your goals, target audience, and the unique challenges you encounter. We harness cutting-edge technologies and industry knowledge to create mobile apps that not only resolve your business challenges but also offer an intuitive and delightful user experience.
              <a href="https://api.whatsapp.com/send?phone=917670837961&text=Hi%20Techweblabs%2C%20I%20am%20interested%20in%20your%20food%20delivery%20app%20development%20services!" class="btn-outline lnk mt30">Request A Quote <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
  ...
  <div class="techonology-used-">
    <div class="container">
      <ul class="h-scroll tech-icons">
        <li><a href="#"><img src="images/icons/mobile/android.png" alt="Food Delivery App Development Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/ios.png" alt="Food Delivery App Development Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/flutter.png" alt="Food Delivery App Development Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/react.png" alt="Food Delivery App Development Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/kotlin.png" alt="Food Delivery App Development Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/swift.png" alt="Food Delivery App Development Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/maps.png" alt="Food Delivery App Development Image"></a></li>
        <li><a href="#"><img src="images/icons/mobile/firebase.png" alt="Food Delivery App Development Image"></a></li>
      ...
      <div class="row upset link-hover">
        <div class="col-lg-6 col-sm-6 mt30  wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
          <div class="s-block wide-sblock">
            <div class="s-card-icon-large"><img src="images/service-mob-service-item2.png" alt="Food Delivery App Development Image" class="img-fluid"></div>
        ...
        <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
          <div class="s-block wide-sblock">
            <div class="s-card-icon-large"><img src="images/service-mob-service-item1.png" alt="Food Delivery App Development Image" class="img-fluid"></div>
            <div class="s-block-content-large">
        ...
        <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
          <div class="s-block wide-sblock">
            <div class="s-card-icon-large"><img src="images/service-mob-service-item3.png" alt="Food Delivery App Development Image" class="img-fluid"></div>
            <div class="s-block-content-large">
        ...
        <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
          <div class="s-block wide-sblock">
            <div class="s-card-icon-large"><img src="images/service-mob-service-item4.png" alt="Food Delivery App Development Image" class="img-fluid"></div>
            <div class="s-block-content-large">
    ...
    <div class="container">
      ...
      <div class="row upset justify-content-center mt60">
        <div class="col-lg-4 v-center order1">
          <div class="image-block1"> <img src="images/process-process-1.jpg" alt="Food Delivery App Development Image" class="img-fluid"> </div>
        </div>
      ...
      <div class="row upset justify-content-center mt60">
        ...
        <div class="col-lg-4 v-center order1">
          <div class="image-block1"> <img src="images/process-process-2.jpg" alt="Food Delivery App Development Image" class="img-fluid"> </div>
        </div>
      </div>
      <div class="row upset justify-content-center mt60">
        <div class="col-lg-4 v-center order1">
          <div class="image-block1"> <img src="images/process-process-3.jpg" alt="Food Delivery App Development Image" class="img-fluid"> </div>
        </div>
        <div class="col-lg-7 v-center order2">
      ...
      <div class="row upset justify-content-center mt60">
        ...
        <div class="col-lg-4 v-center order1">
          <div class="image-block1"> <img src="images/process-process-4.jpg" alt="Food Delivery App Development Image" class="img-fluid"> </div>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="images/icons-teama.svg" alt="Food Delivery App Development Image" class="img-fluid"></div>
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="images/icons-link.svg" alt="Food Delivery App Development Image" class="img-fluid"></div>
            <div class="s-block-content">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="images/icons-tech.svg" alt="Food Delivery App Development Image" class="img-fluid"></div>
            <div class="s-block-content">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="images/icons-hi.svg" alt="Food Delivery App Development Image" class="img-fluid"></div>
            <div class="s-block-content">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="images/icons-badge.svg" alt="Food Delivery App Development Image" class="img-fluid"></div>
            <div class="s-block-content">
        ...
        <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
          <div class="s-block wide-sblock">
            <div class="s-card-icon"><img src="images/icons-tin.svg" alt="Food Delivery App Development Image" class="img-fluid"></div>
            <div class="s-block-content">
...
<div class="logowide mb20"><img src="images/client/customer-logo-5.png" alt="Food Delivery App Development Image" class="img-fluid"></div>
...
<div class="desktopblock shadow1"><img src="images/portfolio/portfolio-wide-1.jpg" alt="Food Delivery App Development Image" class="img-fluid"> </div>
<div class="mobileblock shadow1"><img src="images/portfolio/portfolio-wide-1a.jpg" alt="Food Delivery App Development Image" class="img-fluid"> </div>
</div>
</div>
</div>
</div>
                ...
                <div id="mc_embed_signup_scroll">
                  ...
                  <div class="optionalParent">
                    <div class="clear foot"> <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button" value="Subscribe">
                      <p style="margin: 0px auto;"><a href="http://eepurl.com/izSV7w" title="Mailchimp - email marketing made easy and fun"><span style="display: inline-block; background-color: transparent; border-radius: 4px;"><img class="refferal_badge" src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/intuit-mc-rewards-text-dark.svg" alt="Food Delivery App Development Image" style="width: 220px; height: 40px; display: flex; padding: 2px 0px; justify-content: center; align-items: center;"></span></a></p>
                    </div>
                  </div>
                </div>
              </form>
