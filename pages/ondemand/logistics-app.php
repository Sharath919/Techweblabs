...
?> 
        ...
        <div class="container">
						...
						<div class="row mt30 justify-content-center">
							<a href="#" target="blank" class="wow fadeIn col-lg-4 col-4"
								data-wow-delay=".2s"><img src="images/about-reviews-icon-1.png"
									alt="Logistics App Development Image" class="img-fluid"></a>
							<a href="#" target="blank" class="wow fadeIn col-lg-4 col-4"
          ...
          <div class="col-lg-6 col-md-12"  data-aos="fade-in" data-aos-duration="1500">
            ...
            <img src="images/deliveroo/deliveroo-5.png" alt="Logistics App Development Image" class="img-fluid no-shadow">
          </div>
          <!-- banner slides end -->
        </div>
        </div>
			...
			<div class="container">
				<div class="logo-weworkfor owl-carousel">
					<div class="items"><img src="images/logo/vasiredy.png"
							alt="Logistics App Development Image" class="img100w"></div>
              ...
              <div class="row small t-ctr mt0">
                  <div class="col-lg-3 col-sm-6">
                      <div class="statistics">
                          <div class="statistics-img"> <img src="images/icons-deal.svg" alt="Logistics App Development Image" class="img-fluid"> </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="statistics">
                          <div class="statistics-img"> <img src="images/icons-computers.svg" alt="Logistics App Development Image" class="img-fluid"> </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="statistics">
                          <div class="statistics-img"> <img src="images/icons-worker.svg" alt="Logistics App Development Image" class="img-fluid"> </div>
                  ...
                  <div class="col-lg-3 col-sm-6">
                      <div class="statistics mb0">
                          <div class="statistics-img"> <img src="images/icons-customer-service.svg" alt="Logistics App Development Image" class="img-fluid"> </div>
      ...
      <div class="container">
        ...
        <div class="feature_detail p-0">
          ...
          <div class="left_data feature_box">
            ...
            <div class="icon">
                <img src="images/secure_data.png" alt="Logistics App Development Image" >
              </div>
              <div class="text">
                <h4>Data Security</h4>
                <p> This content is solely focused on logistics-app related information, highlighting Techweblabs' expertise in its development.</p>
              </div>
            </div>
            ...
            <div class="data_block" data-aos="fade-right" data-aos-duration="1500">
            <div class="icon">
                <img src="images/functional.png" alt="Logistics App Development Image" >
              </div>
              <div class="text">
                <h4>Fully Functional</h4>
                <p> This revised content integrates mentions of both logistics-app emphasizing Techweblabs' support for developing similar on-demand delivery platforms. </p>
              </div>
            </div>
          </div>
          ...
          <div class="right_data feature_box">
            ...
            <div class="icon">
                <img src="images/live-chat.png" alt="Logistics App Development Image" >
              </div>
              <div class="text">
                <h4>Live Chat Support</h4>
                <p>Techweblabs offers immediate assistance and solutions through live chat, guaranteeing a seamless and responsive experience for all your logistics-app inquiries. </p>
              </div>
            </div>
            ...
            <div class="data_block" data-aos="fade-left" data-aos-duration="1500">
            <div class="icon">
                <img src="images/support.png" alt="Logistics App Development Image" >
              </div>
              <div class="text">
                <h4>Quick Issue Resolution</h4>
                <p>Our 24/7 support logistics-app  ensures rapid issue resolution, minimizing downtime and disruptions to your app's operation.</p>
              </div>
            </div>
          ...
          <div class="feature_img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="100">
            <img src="images/deliveroo/deliveroo-6.png" alt="Logistics App Development Image" >
          </div>
        </div>
      </div>
      <!-- container end -->
        ...
        <div class="row">
            ...
            <div class="ui_text">
              ...
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  ...
                  <p>Allow users to create accounts, sign in, and manage their profiles with personal information and preferences.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Service Selection</h4>
                  <p>Enable users to book various transportation services, including trucks, vans, or other vehicles, based on their needs.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Service Selection</h4>
                  <p>Offer a variety of services such as goods transportation, home relocation, and commercial logistics.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-6.png" alt="Logistics App Development Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-7.png" alt="Logistics App Development Image" >
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-15.png" alt="Logistics App Development Image" >

                <!-- <img class="moving_position_animatin" src="images/deliveroo/deliveroo-5.png" alt="Logistics App Development Image" > -->
                <!-- <img class="moving_position_animatin" src="images/modern03.png" alt="Logistics App Development Image" > -->
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="row_am modern_ui_section ">
      ...
      <div class="container">
        ...
        <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-8.png" alt="Logistics App Development Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-9.png" alt="Logistics App Development Image" >
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-10.png" alt="Logistics App Development Image" >
                <!-- <img class="moving_position_animatin" src="images/deliveroo/deliveroo-11.png" alt="Logistics App Development Image" > -->
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            ...
            <div class="ui_text">
              ...
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  ...
                  <p>Allow vendors and service providers to create accounts, complete their profiles, and manage business information.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Order Management</h4>
                  <p>Provide tools for vendors to manage incoming orders, including order details, customer information, and delivery schedules.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Inventory Management</h4>
                  <p>Offer tools for vendors to manage their inventory, update stock levels, and add new products or services.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
      ...
      <div class="container">
        ...
        <div class="row">
            ...
            <div class="ui_text  ml-5 p-0">
              ...
              <ul class="design_block">
                <li data-aos="fade-up" data-aos-duration="1500">
                  ...
                  <p>Allow drivers to create accounts, complete their profiles, and manage their personal information and preferences.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                ...
                <li data-aos="fade-up" data-aos-duration="1500">
                  <h4>Order Details</h4>
                  <p> Display detailed information about the service orders, including pickup and delivery locations, items to be transported, and special instructions.</p>
                </li>
              </ul>
              <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
          ...
          <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-12.png" alt="Logistics App Development Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-13.png" alt="Logistics App Development Image" >
                <img class="moving_position_animatin" src="images/deliveroo/deliveroo-14.png" alt="Logistics App Development Image" >
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="row_am modern_ui_section ">
      ...
      <div class="container">
        ...
        <div class="col-lg-6">
            ...
            <div class="ui_images" data-aos="fade-in" data-aos-duration="1500">
              <div class="left_img">
                <img class="moving_position_animatin" src="images/fashion/fashion-2.png" alt="Logistics App Development Image" >
              </div>
              <!-- UI Image -->
              <div class="right_img">
                <!-- <img class="moving_position_animatin" src="images/taxigo/cst-2.png" alt="Logistics App Development Image" > -->
                <!-- <img class="moving_position_animatin" src="images/taxigo/Taxi Rider.png" alt="Logistics App Development Image" > -->
          ...
          <div class="col-lg-6">
              ...
              <ul class="design_block">
                ...
                <h4>User Management</h4>
                  <p>Admins can manage user accounts, including user registration, profile details, and account verification.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Vendor Management</h4>
                  <p>Allow admins to oversee and manage vendor accounts, including verification, approvals, and service offerings.</p>
                </li>
                <li data-aos="fade-up" data-aos-duration="1500">
                <h4>Content Management</h4>
                  <p>Control and update content displayed on the app, such as FAQs, terms of service, and privacy policies.</p>
                </li>
                <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
              </ul>
					...
					<div class="col-lg-7 ">
						<div class="pl50">
							<div class="shape shape-a1"><img src="images/shape-shape-3.svg"
									alt="Logistics App Development Image"></div>
									...
									<div class="client-thumbs mt30">
										<div class="media v-center upset">
											<div class="user-image bdr-radius"><img
													...
													alt="Logistics App Development Image"
...
<!-- testinomial End -->
    ...
    <section class="service pad-tb bg-gradient5">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="image-block wow fadeIn"> <img src="images/deliveroo/deliveroo-5.png" width="100%" hight="700px" alt="Logistics App Development Image" class="img-fluid no-shadow"> </div>
                </div>
                <div class="col-lg-7 block-1">
                    <div class="common-heading text-l pl25"> <span>Overview</span>
                        <h2>Techweblabs Support: Your Key to a Successfull  logistics-app </h2>
                        <p> Techweblabs, with a wealth of experience spanning 6 years, stands as a distinguished leader in  logistics-app support and development. Our comprehensive support services for  logistics-apps are meticulously crafted to enhance brand recognition and drive substantial sales growth for food business owners, reflecting the success of industry giants in the food delivery sector</p>
                        <a href="https://wa.link/fucwsq" class="btn-outline lnk mt30">Request A Quote <i
									class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>  
                    </div>
                </div>
    ...
    <div class="techonology-used-">
        <div class="container">
            <ul class="h-scroll tech-icons">
                <li><a href="#"><img src="images/icons/mobile/android.png" alt="Logistics App Development Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/ios.png" alt="Logistics App Development Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/flutter.png" alt="Logistics App Development Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/react.png" alt="Logistics App Development Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/kotlin.png" alt="Logistics App Development Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/swift.png" alt="Logistics App Development Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/maps.png" alt="Logistics App Development Image"></a></li>
                <li><a href="#"><img src="images/icons/mobile/firebase.png" alt="Logistics App Development Image"></a></li>
        ...
        <div class="row upset link-hover">
            <div class="col-lg-6 col-sm-6 mt30  wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item2.png" alt="Logistics App Development Image" class="img-fluid"></div>
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item1.png" alt="Logistics App Development Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item3.png" alt="Logistics App Development Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
            ...
            <div class="col-lg-6 col-sm-6 mt30 wow fadeInUp" data-wow-delay=".8s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeInUp;">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon-large"><img src="images/service-mob-service-item4.png" alt="Logistics App Development Image" class="img-fluid"></div>
                    <div class="s-block-content-large">
    ...
    <div class="container">
        ...
        <div class="row upset justify-content-center mt60">
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-1.jpg" alt="Logistics App Development Image" class="img-fluid"> </div>
            </div>
        ...
        <div class="row upset justify-content-center mt60">
            ...
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-2.jpg" alt="Logistics App Development Image" class="img-fluid"> </div>
            </div>
        </div>
        <div class="row upset justify-content-center mt60">
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-3.jpg" alt="Logistics App Development Image" class="img-fluid"> </div>
            </div>
            <div class="col-lg-7 v-center order2">
        ...
        <div class="row upset justify-content-center mt60">
            ...
            <div class="col-lg-4 v-center order1">
                <div class="image-block1"> <img src="images/process-process-4.jpg" alt="Logistics App Development Image" class="img-fluid"> </div>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-6 mt30  wow fadeIn" data-wow-delay=".2s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-teama.svg" alt="Logistics App Development Image" class="img-fluid"></div>
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".5s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-link.svg" alt="Logistics App Development Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay=".8s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-tech.svg" alt="Logistics App Development Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.1s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-hi.svg" alt="Logistics App Development Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.4s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-badge.svg" alt="Logistics App Development Image" class="img-fluid"></div>
                    <div class="s-block-content">
            ...
            <div class="col-lg-4 col-sm-6 mt30 wow fadeIn" data-wow-delay="1.7s">
                <div class="s-block wide-sblock">
                    <div class="s-card-icon"><img src="images/icons-tin.svg" alt="Logistics App Development Image" class="img-fluid"></div>
                    <div class="s-block-content">
...
<div class="logowide mb20"><img src="images/client/customer-logo-5.png" alt="Logistics App Development Image" class="img-fluid"></div>
...
<div class="desktopblock shadow1"><img src="images/portfolio/portfolio-wide-1.jpg" alt="Logistics App Development Image" class="img-fluid"> </div>
<div class="mobileblock shadow1"><img src="images/portfolio/portfolio-wide-1a.jpg" alt="Logistics App Development Image" class="img-fluid"> </div>
</div>
</div>
</div>
</div>
                                ...
                                <div id="mc_embed_signup_scroll">
                                    ...
                                    <div class="optionalParent">
                                        <div class="clear foot"> <input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button" value="Subscribe">
                                            <p style="margin: 0px auto;"><a href="http://eepurl.com/izSV7w" title="Mailchimp - email marketing made easy and fun"><span style="display: inline-block; background-color: transparent; border-radius: 4px;"><img class="refferal_badge" src="https://digitalasset.intuit.com/render/content/dam/intuit/mc-fe/en_us/images/intuit-mc-rewards-text-dark.svg" alt="Logistics App Development Image" style="width: 220px; height: 40px; display: flex; padding: 2px 0px; justify-content: center; align-items: center;"></span></a></p>
                                        </div>
                                    </div>
                                </div>
                            </form>
