<?php
// Load config first to ensure ROOT_DIR is defined
...
<html lang="en" class="no-js">
    ...
    <!-- Author and Viewport -->
		...
		<!-- Schema.org Structured Data - Enhanced for AI Search -->
		...
		<style>
			...
			.breadcrumb-areav2{
				background-image: linear-gradient(45deg, #4a0079 0, #4202b2 50%, #4400b1 100%)!important;
			}
			.nx-dropdown {
				opacity: 0;
				height: 0;
			...
			div.custom-nav>ul>li:focus-within .nx-dropdown,
			div.custom-nav>ul>li.active .nx-dropdown {
				opacity: 1;
				height: auto;
				overflow: inherit;
			}
	...
	<body>
		...
		<?php include ('pages/homepage/index.php'); ?>
								...
								<form action="https://techweblabs.us12.list-manage.com/subscribe/post?u=f8dac0f0b06f27b732453861c&amp;id=7a7954abd4&amp;f_id=002141e0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank">
									<div id="mc_embed_signup_scroll">
										...
										<div aria-hidden="true" style="position: absolute; left: -5000px;">
											<input type="text" name="b_f8dac0f0b06f27b732453861c_7a7954abd4" tabindex="-1" value="">
										</div>
										<div class="optionalParent">
											<div class="clear foot">
												<input type="submit" name="subscribe" id="mc-embedded-subscribe" class="button" value="Subscribe">
												<p style="margin: 0px auto;">
													<a href="http://eepurl.com/izSV7w" title="Mailchimp - email marketing made easy and fun">
		...
		<!-- JavaScript Files -->
		<script data-cfasync="false" src="js/cloudflare-static-email-decode.min.js" defer></script>
		...
		<script type="text/javascript">
			...
			(function () {
				...
				s1.async = true;
				s1.src = 'https://embed.tawk.to/650299aa0f2b18434fd86d76/1ha92ghq1';
				s1.charset = 'UTF-8';
