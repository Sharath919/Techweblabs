...
/**
 * Outputs the footer background animation.
 *
 * @since 1.0.0
 */
function bloghash_footer_background_animation_output() {

	if ( ! bloghash_option( 'footer_background_animation' ) ) {
		return;
	}
	?>
...
add_action( 'bloghash_footer', 'bloghash_footer_background_animation_output', 31 );
...
function bloghash_body_animation() {
	...
	<?php elseif ( '2' === $body_animation_option ) : ?>
